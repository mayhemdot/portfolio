...
// type Props = { verifyUrl: string }

// export const ForgotPasswordTemplate = ({ verifyUrl }: Props) => (
//   <Html>
//     <Head />
//     <Body style={main}>
...
//           This link only be valid for the next 7 days. If the link does not
//           work, try to reach out to the support team and raise your query:
//         </Text>
//         <Hr style={hr} />
