	...
	"inline-flex items-center rounded-md border px-2.5 py-1 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
	{
		variants: {
			variant: {
				...
				ghost: "border-black bg-transparent ",
				warn: "border-transparent bg-yellow-300 text-secondary-foreground shadow hover:bg-yellow-300/80",
				success:
					"border-transparent bg-green-300 text-secondary-foreground shadow hover:bg-green-300/80",
			},
		},
		defaultVariants: {
			variant: "default",
