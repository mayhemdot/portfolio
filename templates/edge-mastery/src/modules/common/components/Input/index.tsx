...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  (
    { type, name, label, errors, placeholder, required, topLabel, ...props }, //touched,
    ref,
  ) => {
    ...
    return (
      <InputNextUI
        ...
        defaultValue={String(props.defaultValue) as string}
        endContent={
          type === "password" && (
            <button
...
{
  /*  <div className="flex flex-col w-full"> {topLabel && (
