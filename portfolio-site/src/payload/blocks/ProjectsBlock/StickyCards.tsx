...
// 		<section
// 			id="works"
// 			className="min-h-dvh bg-black dark:bg-card text-white dark:text-black"
// 		>
// 			<Bounded className={"fl-py-120/200"}>
...
// 								<div
// 									key={id}
// 									className="projectContainer flex flex-col md:flex-row items-center"
// 								>
