...
export const EyeOff: React.FC<LucideProps> = ({ size = "20", color = "currentColor", ...attributes }) => {
  return (
    <svg
      role="img"
      width={size}
    ...
    >
      ...
      />
      <path d="M2.5 2.5L17.5 17.5" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
};

export const Eye: React.FC<LucideProps> = ({ size = "20", color = "currentColor", ...attributes }) => {
  return (
