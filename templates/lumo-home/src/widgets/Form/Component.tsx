...
import { EmailInput } from "@/widgets/Form/Email";
import { FormProvider } from "@/widgets/Form/providers";
...
> = (props) => {
  ...
  return (
    <section className="xl:min-w-2xl fl-px-8/32 mx-auto flex h-[70vh] w-fit max-w-full flex-col items-center justify-center xl:h-screen">
